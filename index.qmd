...
```{ojs}
summons_csv = FileAttachment("jaywalking-crim-summonses_quarterly.csv").csv({typed: true})
...
```{ojs}
jwalkrace5_data = FileAttachment("jaywalking_race_5.csv").csv({typed: true})
jwalkrace2_data = FileAttachment("jaywalking_race_2.csv").csv({typed: true})
...
In 2024 alone, 62% of summonses were issued to Black individuals and 31% to Hispanic individuals. [@cr-race]{pan-to="-70%,-15%" scale-by="2.5"}
...
Five precincts ([**25**]{style="color:#660000;"}, [**28**]{style="color:#1850b5;"}, [**32**]{style="color:#ba9f64;"}, [**33**]{style="color:#1f3a70;"}, and [**76**]{style="color:#b3b3ff;"}), for instance, are in the top 25th percentile for jaywalking summonses [@cr-precincts]{pan-to="35%,65%" scale-by="1.75"}

Yet fall in the bottom 25th percentile for pedestrian-related car crashes. This mismatch suggests that enforcement may not be driven by safety considerations alone. [@cr-precincts]{pan-to="60%,-60%" scale-by="2.5"}
...
```{ojs}
precinct_data = FileAttachment("summonses-vs-ksi_by-precinct_2017-2024.csv").csv({typed: true});
...
```{ojs}
race_enforcement5_data = FileAttachment("race_filtered_by_enforcement.csv").csv({typed: true})
race_enforcement2_data = FileAttachment("race_filtered_by_enforcement_2.csv").csv({typed: true})
